...
본 교과목에서는 산업공학과에서 다루는 주요 분야 중 확률통계 및 회귀분석을 주제로 한 특론으로, 확률변수와 확률분포, 이를 활용한 추정 및 검정과 회귀분석에 대한 이론적인 학습과 더불어 R 소프트웨어 프로그램을 활용하여 학습한 내용을 구현하고, 실제 산업 시스템 데이터를 분석하기 위한 실습 활동을 진행한다. 수업은 이론과 R 실습을 병행하는 형식으로 진행될 예정이며, 수강생은 2주차 강의부터 모두 노트북을 지참하여야 한다.
